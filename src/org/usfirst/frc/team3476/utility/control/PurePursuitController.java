...
public class PurePursuitController {
	...
	public synchronized DriveVelocity calculate(RigidTransform robotPose) {
		...
		// Motion Profiling
		double lookAheadDist = OrangeUtility.coercedNormalize(speedProfiler.getLatestValue(), Constants.MinPathSpeed, Constants.MaxPathSpeed, Constants.MinLookAheadDistance, Constants.MaxLookAheadDistance);
